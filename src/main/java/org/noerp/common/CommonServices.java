...
import static org.noerp.base.util.UtilGenerics.checkMap;
...
import org.noerp.base.metrics.Metrics;
import org.noerp.base.metrics.MetricsFactory;
...
import org.noerp.service.ServiceSynchronization;
import org.noerp.service.ServiceUtil;
import org.noerp.service.mail.MimeMessageWrapper;
...
public class CommonServices {
    ...
    public static Map<String, Object> byteBufferTest(DispatchContext dctx, Map<String, ?> context) {
        ...
        String outputPath1 = noerpHome + (fileName1.startsWith("/") ? fileName1 : "/" + fileName1);
        String outputPath2 = noerpHome + (fileName2.startsWith("/") ? fileName2 : "/" + fileName2);
    ...
    public static Map<String, Object> uploadTest(DispatchContext dctx, Map<String, ?> context) {
        ...
        createCtx.put("dataResourceTypeId", "NOERP_FILE");
