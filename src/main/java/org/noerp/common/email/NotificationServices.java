 ...
 * under the License.
 *******************************************************************************/
package org.noerp.common.email;
...
import org.noerp.base.component.ComponentConfig.WebappInfo;
...
import org.noerp.webapp.NoerpUrlBuilder;
import org.noerp.webapp.WebAppUtil;
    ...
    public static void setBaseUrl(Delegator delegator, String webSiteId, Map<String, Object> context) {
        ...
        if (!context.containsKey("baseUrl")) {
            try {
                ...
                NoerpUrlBuilder builder = NoerpUrlBuilder.from(webAppInfo, delegator);
