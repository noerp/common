...
<#assign useMultitenant = Static["org.noerp.base.util.UtilProperties"].getPropertyValue("general.properties", "multitenant")>
...
<center>
  <div class="screenlet login-screenlet">
    ...
    <div class="screenlet-body">
      <form method="post" action="<@noerpUrl>login</@noerpUrl>" name="loginform">
        ...
        <br />
        <a href="<@noerpUrl>forgotPassword_step1</@noerpUrl>">${uiLabelMap.CommonForgotYourPassword}?</a>
      </form>
    </div>
  </div>
</center>
