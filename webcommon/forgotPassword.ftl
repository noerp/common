...
<center>
  <div class="screenlet login-screenlet">
    ...
    <div class="screenlet-body">
      <form method="post" action="<@noerpUrl>forgotPassword${previousParams!}</@noerpUrl>" name="forgotpassword">
        ...
        <a href='<@noerpUrl>authview</@noerpUrl>' class="button">${uiLabelMap.CommonGoBack}</a>
