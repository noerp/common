...
<script type="text/javascript" src="/assets/jquery/plugins/fancybox/jquery.fancybox-1.3.4.pack.js"></script>
<link rel="stylesheet" href="/assets/jquery/plugins/fancybox/jquery.fancybox-1.3.4.css" type="text/css" media="screen" />
...
<div class="screenlet" style="margin: 1em;">
  <div class="screenlet-title-bar">
    <ul>
      ...
      <li><a href="<@noerpUrl>main</@noerpUrl>">${uiLabelMap.CommonDone}</a></li>
    </ul>
    <br class="clear"/>
  </div>
  <li class="h2" style="padding-top:1em">${uiLabelMap.CommonVisualThemeUsage}</li>
  <#if visualThemes?has_content>
    <#assign orderByList = Static["org.noerp.base.util.UtilMisc"].toList("visualThemeId")/>
    <table cellspacing="0" class="basic-table">
      <#list visualThemes as visualTheme>
        <#assign screenshots = delegator.findByAnd("VisualThemeResource", Static["org.noerp.base.util.UtilMisc"].toMap(
        ...
        <tr<#if visualTheme.visualThemeId == visualThemeId> class="selected"</#if>>
          <td>
            <form name="SetUserPreferences_${visualTheme.visualThemeId}" method="post" action="<@noerpUrl>setUserPreference</@noerpUrl>">
          ...
          <td>
            <#if screenshots?has_content>
              <#list screenshots as screenshot>
                <a id="single_image" href="<@noerpContentUrl>${screenshot.resourceValue}</@noerpContentUrl>"><img src="<@noerpContentUrl>${screenshot.resourceValue}</@noerpContentUrl>" width="150" alt=""/></a>
              </#list>
           <#else>
