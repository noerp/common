...
under the License.
-->
<script language="javascript" type="text/javascript" src="<@noerpContentUrl>/assets/jquery/plugins/flot/excanvas.min.js</@noerpContentUrl>"></script>
<script language="javascript" type="text/javascript" src="<@noerpContentUrl>/assets/jquery/plugins/flot/jquery.flot.js</@noerpContentUrl>"></script>
<script language="javascript" type="text/javascript" src="<@noerpContentUrl>/assets/jquery/plugins/flot/jquery.flot.pie.js</@noerpContentUrl>"></script>
