...
<head>
    ...
    function initJQuery() {
        if (typeof(jQuery) == 'undefined') {
            if (!jQueryLibLoaded) {
                ...
                document.write("<scr" + "ipt type=\"text/javascript\" src=\"<@noerpContentUrl>/assets/jquery/jquery-1.11.0.min.js</@noerpContentUrl>\"></scr" + "ipt>");
                document.write("<scr" + "ipt type=\"text/javascript\" src=\"<@noerpContentUrl>/assets/jquery/jquery-migrate-1.2.1.js</@noerpContentUrl>\"></scr" + "ipt>");
            }
    ...
    initJQuery();
    //]]></script>
    <script language="javascript" src="<@noerpContentUrl>/assets/selectall.js</@noerpContentUrl>" type="text/javascript"></script>
    ...
    <#if layoutSettings.styleSheets?has_content>
        <#list layoutSettings.styleSheets as styleSheet>
            <link rel="stylesheet" href="<@noerpContentUrl>${styleSheet}</@noerpContentUrl>" type="text/css"/>
        </#list>
    </#if>
